-- Reorder email_verified column to come after email field
...
INSERT INTO users_new (id, clerk_user_id, email, email_verified, full_name, username, image_url, active, last_sign_in, created_at, updated_at, deleted_at)
SELECT id, clerk_user_id, email, email_verified, full_name, username, image_url, active, last_sign_in, created_at, updated_at, deleted_at
FROM users;
